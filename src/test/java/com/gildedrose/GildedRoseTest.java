...
class GildedRoseTest {
    ...
    @Test
    void itemSellingDecreasesByOneAndQualityDecreasesByOne() {
    ...
    @Test
    void agedBrieSellingDecreasesByOneAndQualityIncreasesByOne() {
    ...
    @Test
    void backstagePassesSellingDecreasesByOneAndQualityIncreasesByThree() {
        ...
        String actual = app.items[0].sellIn + ", " + app.items[0].quality;
        assertEquals("4, 13", actual);
    }

    @Test
    void sulfurasSellingDecreasesByOneAndQualityDecreasesByOne() {
    ...
    @Test
    void handOfRagnarosSellingDecreasesByOneAndQualityDecreasesByOne() {
        Item[] items = new Item[]{new Item("Hand of Ragnaros", 5, 10)};
    ...
    @Test
    void conjuredMamaCakesSellingDecreasesByOneAndQualityDecreasesByOne() {
